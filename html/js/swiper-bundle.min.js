...
!function (e, t) {
    ...
    var Y = {
        ...
        modular: {
            ...
            updateSize: function () {
                ...
                var y = e.snapGrid.length, w = e.snapGrid.length, b = a.spaceBetween, E = -m, x = 0, T = 0;
                if (void 0 !== s) {
                    var C, M;
    ...
    var U = {
        ...
        create: function () {
            M(this, {a11y: t(t({}, ie), {}, {liveRegion: m('<span class="' + this.params.a11y.notificationClass + '" aria-live="assertive" aria-atomic="true"></span>')})})
        },
        on: {
